...
CUDA_VISIBLE_DEVICES=0,1 torchrun --nproc_per_node=2 --master_port=35714 train_ddp.py --output_dir "outputs/figures_ablation_comparison_noaux64" --exp_name ours_noaux_full $COMMON_ARGS --use_aux false --mask_aware true --use_spectral_stem true --deep_supervision true --loss combined --find_unused_parameters true
