...
if __name__ == "__main__":
    ...
    parser.add_argument('input_file',default="/data3/lrx/era5/data.grib", help='输入的GRIB文件路径')
    parser.add_argument('-o', '--output', default='/data3/lrx/era5/split_data', 
                       help='输出目录 (默认: /data3/lrx/era5/split_data)')
